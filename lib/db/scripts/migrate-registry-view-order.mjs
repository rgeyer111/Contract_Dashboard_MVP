...
try {
  ...
  `);
  await client.query(
    "DROP INDEX IF EXISTS registry_views_pinned_order_unique",
  );
  await client.query(`
    CREATE UNIQUE INDEX IF NOT EXISTS registry_views_account_pinned_order_unique
    ON registry_views (account_id, pinned_order)
